...
Also check: if the founder is transitioning between companies or the startup details are ambiguous from the profile alone, do NOT conduct market research. Instead respond with:
